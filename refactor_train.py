...
from utils.dataset import construct_loader, construct_loader_new
...
def train(args, model, optimizer, scheduler, train_loader, val_loader):
    ...
    for epoch in range(args.n_epochs):
        ...
        if epoch % 50 ==0:
            epoch_model_path = 'epoch' + str(epoch) + '.pt'
            torch.save(model.state_dict(), os.path.join(args.log_dir, epoch_model_path))
            torch.save({
                'epoch': epoch,
...
if __name__ == '__main__':
    ...
    print(args)
    # parent_dir = '/path/tocheckpoints/'
    parent_dir = '/path/to/torsional_diffusion/'
    ...
    if args.restart_dir:
        ...
        args.log_dir = args.log_dir + '_restart'
        print('reload!')
        print(model)
# write training restart here
    ...
    # train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag/merged_train_data.pkl'
    if args.restart_dir:
        train_data_path = '/path/to/DRUGS/fragdiff_dump/merged_train_data.pkl'
        # train_data_path = '/path/to/DRUGS/fragdiff_dump/train_samples_1.pkl'
    elif 'brics' in args.log_dir:
        train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag_brics/frag_train_data.pkl'
    elif 'recap' in args.log_dir:
        train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag_recap/frag_train_data.pkl'
    elif 'braug' in args.log_dir:
        train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag_braug/frag_train_data.pkl'
    else:
        train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag/merged_train_data.pkl'
    print(train_data_path)
    # train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag_recap/frag_train_data.pkl'
    # train_data_path = '/path/to/DRUGS/fragdiff_dump/_frag_braug/frag_train_data.pkl'
    val_data_path = '/path/to/DRUGS/fragdiff_dump/val_samples_1.pkl'
    ...
    # train_data_path = ''
    # val_data_path = ''
    train_loader, val_loader = construct_loader_new(args, train_data_path, val_data_path)
