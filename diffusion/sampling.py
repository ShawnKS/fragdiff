...
def get_seed(smi, seed_confs=None, dataset='drugs', dec='none'):
    if seed_confs:
    ...
    data.mol = mol
    data.edge_mask, data.mask_rotate, _ = get_transformation_mask_old(data)
    # if dec == 'none':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_old(data)
    # if dec == 'frag_conn':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_frag(data)
    # if dec == 'frag_all':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_all(data)
    # if dec == 'recap':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_recap(data)
    # if dec == 'brics':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_brics(data)
    # if dec == 'br':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_bnr(data)
    # if dec == 'junc':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_junc(data)
    # if dec == 'junc_none':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_junc_old(data)
    # if dec == 'junc_brics':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_junc_brics(data)
    # if dec == 'junc_recap':
    #     data.edge_mask, data.mask_rotate, _ = get_transformation_mask_junc_recap(data)
