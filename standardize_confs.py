...
def conformer_match(name, confs):
    ...
    if args.dec == 'brics':
        rotable_bonds = get_torsion_angles_brics(mol_rdkit)
    if args.dec == 'recap':
        rotable_bonds = get_torsion_angles_recap(mol_rdkit)
    if args.dec == 'junc':
        rotable_bonds = get_torsion_angles_junc(mol_rdkit)
    if args.dec == 'br':
        rotable_bonds = get_torsion_angles_br(mol_rdkit)
