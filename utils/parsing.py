...
def parse_train_args():
    ...
    parser.add_argument('--cache', type=str, default=None, help='Folder from where to load/restore cached dataset')
    parser.add_argument('--data_dir', type=str, default='/mnt/path/to/DRUGS/drugs/', help='Folder containing original conformers')
    parser.add_argument('--std_pickles', type=str, default=None, help='Folder in which the pickle are put after standardisation/matching')
    parser.add_argument('--split_path', type=str, default='/mnt/path/to/DRUGS/split.npy', help='Path of file defining the split')
    ...
    # Decompose arguments
    parser.add_argument('--dec', type=str, default='none', help='BRICS or RECAP')
    parser.add_argument('--aug', action='store_true', help='Enable augmentation')
    parser.add_argument('--rigid', action='store_true', help='rigid fragmentation and rotation')
    parser.add_argument('--z', type=int, default=0, help='minimumm frag size')
    # Model arguments
